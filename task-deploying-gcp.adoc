...
NOTE: Esta es la cuenta de servicio que configuró para BlueXP, link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html#set-up-a-service-account-for-the-connector["como se describe en esta página"^].
