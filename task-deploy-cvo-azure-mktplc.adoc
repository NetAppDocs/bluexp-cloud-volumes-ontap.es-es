...
NOTE: La implementación directa de Azure Marketplace admite tipos de instancia L8S_v3. Sin embargo, BlueXP  no admite este tipo de instancia para las configuraciones de alta disponibilidad y no podrá detectarlo correctamente durante la detección.
