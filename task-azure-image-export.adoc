...
NOTE: Para obtener más información sobre cómo instalar la CLI de Azure, consulte https://learn.microsoft.com/en-us/cli/azure/install-azure-cli["Documentación de Azure: Cómo instalar la CLI de Azure"^].
...
. Revise el nombre de SKU para el tipo de puesta en marcha de VM correspondiente en la tabla siguiente.
+
