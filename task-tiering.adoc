...
Compruebe que Cloud Volumes ONTAP tenga una conexión con S3. La mejor forma de proporcionar esa conexión es crear un extremo de VPC con el servicio S3. Para ver instrucciones, consulte https://["Documentación de AWS: Crear un extremo de puerta de enlace"^].
...
----
Los permisos se incluyen de forma predeterminada en la función personalizada. https://["Ver permiso de Azure para el conector"^]
...
* La subred en la que reside Cloud Volumes ONTAP debe estar configurada para acceso privado a Google. Para obtener instrucciones, consulte https://["Documentación de Google Cloud: Configuración de Private Google Access"^].
...
+
Para obtener ayuda sobre la replicación de datos, consulte https://["Replicar datos hacia y desde el cloud"^].
