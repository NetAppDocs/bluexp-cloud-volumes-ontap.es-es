...
Un VPC compartido permite configurar y gestionar de forma centralizada las redes virtuales de varios proyectos. Puede configurar redes VPC compartidas en el _proyecto host_ e implementar las instancias de máquina virtual de conector y Cloud Volumes ONTAP en un _proyecto de servicio_. https://["Documentación de Google Cloud: Información general sobre VPC compartido"^].

https://["Revisar los permisos de VPC compartido requeridos que se cubren en la implementación del conector"^]



=== Duplicación de paquetes en VPC

https://["Mirroring de paquetes"^] Debe deshabilitarse en el Google Cloud VPC en que pone en marcha Cloud Volumes ONTAP. Cloud Volumes ONTAP no puede funcionar correctamente si está habilitado el mirroring de paquetes.
...
Una vez que haya comprobado que el acceso saliente a Internet está disponible, puede probar AutoSupport para asegurarse de que puede enviar mensajes. Para obtener instrucciones, consulte https://["Documentos de ONTAP: Configure AutoSupport"^].
...
Si desea organizar en niveles datos inactivos en un bloque de Google Cloud Storage, debe configurarse la subred en la que resida Cloud Volumes ONTAP para Private Google Access (si utiliza una pareja de alta disponibilidad, esta es la subred en VPC-0). Para obtener instrucciones, consulte https://["Documentación de Google Cloud: Configuración de Private Google Access"^].
...
Para obtener instrucciones, consulte https://["Documentación de Google Cloud: Información general sobre Cloud VPN"^].
...
TIP: ¿Busca información sobre el conector? https://["Ver reglas de firewall para el conector"^]
...
* https://["Ver los requisitos de red del conector"^]
