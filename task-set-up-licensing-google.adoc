...
.Pasos
. https://["Póngase en contacto con el equipo de ventas de NetApp para obtener una licencia"^]
. https://["Agregue su cuenta de la página de soporte de NetApp a BlueXP"^]
+
...
TIP: Puede gestionar las suscripciones de Google Cloud Marketplace asociadas con sus cuentas en la página Configuración > credenciales. https://["Descubra cómo administrar sus credenciales y suscripciones a Google Cloud"^]
...
.Pasos
. Si aún no tiene una suscripción, https://["Póngase en contacto con NetApp"^]
