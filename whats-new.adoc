...
=== La región de Alemania ahora es compatible con Google Cloud

La región de Alemania ahora es compatible con Google Cloud para Cloud Volumes ONTAP y el conector para Cloud Volumes ONTAP 9.12.1 GA y posterior.
