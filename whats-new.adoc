...
Cloud Volumes ONTAP ahora es compatible con las siguientes máquinas virtuales de la serie Edv5 con discos gestionados compartidos en zonas únicas y múltiples de disponibilidad, a partir de la versión 9.14.1.
