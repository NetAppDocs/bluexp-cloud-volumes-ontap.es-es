...
Las mejoras descritas en esta página son específicas de las funciones de BlueXP que permiten la gestión de Cloud Volumes ONTAP. Para conocer las novedades del propio software Cloud Volumes ONTAP, https://["Vaya a las notas de la versión de Cloud Volumes ONTAP"^]
...
https://["Aprenda a ver la capacidad consumida en su cuenta"^].
...
https://["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
Más información acerca de https://["Tamaños de disco compatibles en Azure"^].
...
https://["Aprenda a cifrar volúmenes con las soluciones de cifrado de NetApp"^].
...
https://["Aprenda a configurar y gestionar los servicios de almacenamiento de objetos S3 en ONTAP"^]
...
Para obtener información acerca de cómo configurar y utilizar NDMP, consulte https://["Información general de la configuración de NDMP"].
...
Para obtener más información sobre esta nueva funcionalidad, consulte https://["Configure Cloud Volumes ONTAP para utilizar una clave gestionada por el cliente en Azure"].
...
+
https://["Aprenda a cambiar los métodos de carga"].
...
* *Edge Cache*: Licencia para https://["Caché de Cloud Volumes Edge"^]


https://["Obtenga más información sobre estos paquetes de licencias"].
...
https://["Obtenga más información sobre el soporte para volúmenes Elastic en AWS"].
...
https://["Vea la lista completa de las regiones compatibles de Cloud Volumes ONTAP"^]
...
https://["Obtenga más información acerca de la vista avanzada"].
...
https://["Obtenga más información sobre el soporte para volúmenes Elastic"].
...
"ec2:ModifyVolume",
----
Asegúrese de proporcionar estos permisos a cada conjunto de credenciales de AWS que haya añadido a BlueXP. https://["Consulte la última política del conector para AWS"^].
...
https://["Obtenga más información acerca de conexiones de vínculo privado de Azure con Cloud Volumes ONTAP"].
...
* https://["Obtenga más información sobre los límites de máquinas virtuales de almacenamiento en Google Cloud"^]
* https://["Descubra cómo crear máquinas virtuales de almacenamiento de servicios de datos para Cloud Volumes ONTAP en Google Cloud"]
...
https://["Obtenga más información sobre la gestión de datos de Kubernetes en BlueXP"^]
...
https://["Más información sobre las licencias"].
...
https://["Descubra cómo cambiar el tipo de almacenamiento para los datos por niveles"].
...
https://["Consulte las configuraciones compatibles para Cloud Volumes ONTAP en Google Cloud"^]
...
Aún puede conectarse a System Manager introduciendo la dirección IP de administración del clúster en un explorador web que tiene una conexión con el sistema Cloud Volumes ONTAP. https://["Obtenga más información sobre la conexión con System Manager"].
...
https://["Más información sobre los precios del almacenamiento WORM"^].
...
https://["Aprenda a crear volúmenes en un agregado específico"].
...
https://["Obtenga más información sobre las opciones de licencia de Cloud Volumes ONTAP"].
...
https://["Aprenda a intercambiar licencias basadas en nodos sin asignar"].
...
Vaya a la https://["Notas de la versión de Cloud Volumes ONTAP"^] para obtener más información sobre las configuraciones admitidas.
...
* https://["Obtenga más información sobre las suscripciones a NetApp Keystone"^].
...
Los datos se cifran automáticamente en Cloud Volumes ONTAP, en Azure mediante https://["Cifrado del servicio de almacenamiento de Azure"^] Con una clave gestionada por Microsoft. Pero ahora puede utilizar su propia clave de cifrado gestionada por el cliente realizando los siguientes pasos:
...
https://["Consulte las configuraciones compatibles para Cloud Volumes ONTAP en AWS"^].
...
----
Asegúrese de proporcionar estos permisos a cada conjunto de credenciales de Azure que haya añadido a BlueXP. https://["Consulte la última política de Connector para Azure"^].
...
https://["Ver configuraciones admitidas para Cloud Volumes ONTAP en GCP"^].
...
Vaya a la https://["AWS Marketplace"^] para ver los detalles de los precios y vaya al https://["Notas de la versión de Cloud Volumes ONTAP"^] para obtener más información sobre esta opción de licencia.
...
Tenga en cuenta que un conector requiere un nuevo permiso para eliminar instantáneas de Azure. https://["Consulte la última política de Connector para Azure"^].
...
Cloud Volumes ONTAP ahora puede utilizar un Ultra SSD así VNVRAM cuando se utiliza el tipo de máquina virtual E32S_v3 con un sistema de un solo nodo https://["En cualquier región de Azure compatible"^].
...
* https://["Obtenga más información acerca de Azure Private Links"^]
* link:task-enabling-private-link.html["Obtenga más información sobre el uso de un vínculo privado de Azure con cloud Volumes ONTAP"]
