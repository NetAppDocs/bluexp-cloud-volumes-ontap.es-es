...
Sin embargo, la capacidad de agregar o renovar licencias optimizadas estaría disponible a través de las API.
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9151-relnotes/["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
=== Compatibilidad con versiones mínimas para Flash Cache en Azure

La versión mínima de Cloud Volumes ONTAP requerida para configurar Flash Cache en Azure es 9.13.1 GA. Solo puede usar ONTAP 9.13.1 GA y versiones posteriores para implementar Flash Cache en sistemas Cloud Volumes ONTAP de Azure.
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9150-relnotes/["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
Si las directivas de seguridad lo requieren, puede configurar las instancias de EC2 para que utilicen IMDSv2. Para obtener instrucciones, consulte https://docs.netapp.com/us-en/bluexp-setup-admin/task-require-imdsv2.html["Documentación de configuración y administración de BlueXP para gestionar los conectores existentes"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9141-relnotes/["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
Para obtener una lista de todas las regiones que admiten varias zonas de disponibilidad, consulte la https://bluexp.netapp.com/cloud-volumes-global-regions["Mapa de regiones globales en Azure"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9140-relnotes/["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9131-relnotes/["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9131-relnotes["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
Para obtener más información sobre la actualización de Cloud Volumes ONTAP a través de BlueXP , consulte https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-updating-ontap-cloud.html#upgrade-cloud-volumes-ontap["Actualice Cloud Volumes ONTAP"^] .
...
=== Soporte para las regiones de China para AWS
...
Para conocer la disponibilidad regional, consulte la link:https://bluexp.netapp.com/cloud-volumes-global-regions["Mapas de regiones globales para Cloud Volumes ONTAP"^].
...
Los volúmenes de FlexGroup creados mediante ONTAP System Manager o la interfaz de línea de comandos de ONTAP ahora se pueden ver directamente a través del icono Volúmenes rediseñados en BlueXP . Idéntico a la información proporcionada para volúmenes de FlexVol, BlueXP proporciona información detallada sobre los volúmenes de FlexGroup creados mediante un icono de volúmenes dedicados.
...
=== Soporte para las regiones de China en Azure

La región norte de China 3 ahora es compatible con las puestas en marcha de un nodo de Cloud Volumes ONTAP 9.12.1 GA y 9.13.0 GA en Azure. Solo se admiten las licencias adquiridas directamente a través de NetApp (licencias BYOL) en estas regiones.


NOTE: Las nuevas puestas en marcha de Cloud Volumes ONTAP en regiones de China solo se admiten en 9.12.1 GA y 9.13.0 GA. Puede actualizar estas versiones a parches y versiones posteriores de Cloud Volumes ONTAP. Si desea implementar versiones posteriores de Cloud Volumes ONTAP en las regiones de China, póngase en contacto con el soporte de NetApp.
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9130-relnotes["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^].
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-logging-in.html["Acceda a la consola BlueXP del conector"^]
...
Para obtener más información acerca de las licencias de funciones de ONTAP instaladas automáticamente con Cloud Volumes ONTAP, consulte link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/reference-default-configs.html["Configuración predeterminada de Cloud Volumes ONTAP"^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9121-relnotes["Conozca cuáles son las nuevas funciones que se incluyen en esta versión de Cloud Volumes ONTAP"^]
...
https://docs.netapp.com/us-en/ontap/object-storage-management/index.html["Documentación de ONTAP: Aprenda a configurar y gestionar los servicios de almacenamiento de objetos S3"^]
...
Para obtener información sobre cómo configurar y utilizar NDMP, consulte la https://docs.netapp.com/us-en/ontap/ndmp/index.html["Documentación de ONTAP: Información general de la configuración de NDMP"].
...
* *Edge Cache*: Licencia para https://bluexp.netapp.com/cloud-volumes-edge-cache["Caché de Cloud Volumes Edge"^]
...
La pestaña K8s estaba obsoleta en una versión anterior y ahora se ha eliminado.
...
https://bluexp.netapp.com/pricing["Más información sobre los precios del almacenamiento WORM"^].
...
Los datos se cifran automáticamente en Cloud Volumes ONTAP en Azure mediante https://learn.microsoft.com/en-us/azure/security/fundamentals/encryption-overview["Cifrado del servicio de almacenamiento de Azure"^] una clave gestionada por Microsoft. Pero ahora puede utilizar su propia clave de cifrado gestionada por el cliente realizando los siguientes pasos:
