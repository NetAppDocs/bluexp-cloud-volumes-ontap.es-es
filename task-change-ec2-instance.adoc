...
Si no puede cambiar el tipo de instancia de las instancias C4, M4 o R4, consulte el artículo de la base de conocimientos link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Unable_to_change_the_instance_type_from_r4_to_r5_with_disk_count_error["No se puede cambiar el tipo de instancia de R4 a R5 con un error de recuento de discos"^].
