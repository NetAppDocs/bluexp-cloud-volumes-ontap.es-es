...
Si no puede cambiar el tipo de instancia de las instancias C4, M4 o R4, consulte el artículo de la base de conocimientos link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Converting_an_AWS_Xen_CVO_instance_to_Nitro_(KVM)["Convertir una instancia de AWS Xen CVO a Nitro (KVM)"^].
