...
NOTE: En las regiones de China, las puestas en marcha de un solo nodo solo se admiten en Cloud Volumes ONTAP 9.12.1 GA y 9.13.0 GA. Puede actualizar estas versiones a parches y versiones posteriores de Cloud Volumes ONTAP. Si desea implementar versiones posteriores de Cloud Volumes ONTAP en las regiones de China, póngase en contacto con el soporte de NetApp. En estas regiones solo se admiten las licencias adquiridas directamente desde NetApp.
