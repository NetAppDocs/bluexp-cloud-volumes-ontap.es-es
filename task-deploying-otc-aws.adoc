...
+
Si ejecuta una versión de Connector 3.9.36 o anterior, debe agregar el siguiente permiso a la función de conector de AWS en la consola de AWS EC2: Descripción de las zonas disponibles.
