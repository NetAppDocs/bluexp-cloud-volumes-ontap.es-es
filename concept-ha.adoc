...
Debe consultar la documentación de AWS para obtener los detalles más recientes y completos sobre el link:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?nc=sn&loc=2["EC2 Tipos de instancias en Zonas locales"^].
