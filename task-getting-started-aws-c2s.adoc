...
* Debe configurar una puerta de enlace de tránsito cuando implemente Cloud Volumes ONTAP HA en varias zonas de disponibilidad (AZ). Consulte link:task-setting-up-transit-gateway.html["Configure una puerta de enlace de tránsito de AWS"].
