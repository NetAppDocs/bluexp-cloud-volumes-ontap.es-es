...
La gestión avanzada a través del administrador del sistema de ONTAP es compatible con Cloud Volumes ONTAP 9.10.0 y versiones posteriores en regiones del cloud estándar.
