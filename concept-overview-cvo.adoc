...
+
https://docs.netapp.com/us-en/snapcenter/get-started/concept_snapcenter_overview.html["Obtenga más información acerca de SnapCenter"^]
...
https://bluexp.netapp.com/ontap-cloud["Obtenga más información acerca de Cloud Volumes ONTAP"^]
