...
IMPORTANT: NetApp dejará de usar las licencias basadas en nodos en breve, que serán reemplazadas por licencias basadas en capacidad. Para obtener más información, consulte https://mysupport.netapp.com/info/communications/CPC-00589.html["Comunicado del cliente: CPC-00589"^].
