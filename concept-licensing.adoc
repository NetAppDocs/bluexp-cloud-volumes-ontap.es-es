...
IMPORTANT: NetApp acabará en breve con la disponibilidad de licencias basadas en nodos. Tras el fin de la disponibilidad, las licencias basadas en nodos deberán convertirse en licencias basadas en capacidad. Para obtener más información, consulte https://mysupport.netapp.com/info/communications/CPC-00589.html["Comunicado del cliente: CPC-00589"^].
