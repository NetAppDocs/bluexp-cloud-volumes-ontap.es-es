...
Si usted no tiene un https://["Conector"^] Sin embargo, un administrador de cuentas necesita crear uno. https://["Descubra cómo crear un conector en Google Cloud"^]
...
. Si tiene pensado habilitar la organización en niveles de datos, https://["Configure la subred de Cloud Volumes ONTAP para acceso privado a Google"^].
...
[role="quick-margin-para"]
https://["Habilite las siguientes API de Google Cloud en su proyecto"^]. Estas API son necesarias para poner en marcha el conector y Cloud Volumes ONTAP.
...
* https://["Qué hace BlueXP con los permisos de Google Cloud"^]
