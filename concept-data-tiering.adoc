...
Los costes de acceso son más elevados si se accede a los datos, por lo que hay que tener en cuenta antes de cambiar la clase de almacenamiento. https://["Obtenga más información acerca de las clases de almacenamiento de Amazon S3"^].
...
Los costes de acceso son más elevados si accede a los datos, por lo que tenga en cuenta antes de cambiar el nivel de almacenamiento. https://["Obtenga más información acerca de los niveles de acceso al almacenamiento de Azure Blob"^].
...
+
--
Los costes de acceso son más elevados si se accede a los datos, por lo que hay que tener en cuenta antes de cambiar la clase de almacenamiento. https://["Obtenga más información sobre clases de almacenamiento para Google Cloud Storage"^].
...
TIP: Puede cambiar el período mínimo de refrigeración y el umbral predeterminado del agregado del 50% (más información en el siguiente apartado). http://["Aprenda a cambiar el período de enfriamiento"^] y.. http://["aprenda a cambiar el umbral"^].
