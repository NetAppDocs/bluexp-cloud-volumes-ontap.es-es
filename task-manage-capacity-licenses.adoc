...
+
Para comprender mejor las capacidades que se muestran para el paquete Essentials, debería estar familiarizado con cómo funciona la carga. https://["Más información sobre la carga del paquete Essentials"].
...
* Si desea introducir el número de serie, primero tiene que hacerlo https://["Agregue su cuenta de la página de soporte de NetApp a BlueXP"^]. Esta es la cuenta del sitio de soporte de NetApp que está autorizada para acceder al número de serie.
