...
Flash Cache es compatible con configuraciones de Cloud Volumes ONTAP específicas. Consulte las configuraciones admitidas en la https://["Notas de la versión de Cloud Volumes ONTAP"^]
...
+
No elija eficiencia del almacenamiento al crear un volumen desde BlueXP, ni cree un volumen y, a continuación http://["Deshabilite la compresión de datos mediante la CLI"^].
