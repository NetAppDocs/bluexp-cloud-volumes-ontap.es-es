...
La característica ARP está disponible para su uso con suscripciones BYOL y Marketplace para licencias basadas en nodos y en capacidad sin coste adicional. Póngase en contacto con su representante de ventas de NetApp para agregar ARP a su licencia actual.
