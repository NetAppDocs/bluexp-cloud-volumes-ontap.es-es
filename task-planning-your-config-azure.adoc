...
Cloud Volumes ONTAP es compatible en la mayoría de las regiones de Microsoft Azure. https://["Consulte la lista completa de las regiones admitidas"^].
...
https://["Configuraciones compatibles para Cloud Volumes ONTAP en Azure"^]
...
https://["Límites de almacenamiento para Cloud Volumes ONTAP en Azure"^]
...
Si quiere más información sobre los casos de uso de estos discos, consulte https://["Documentación de Microsoft Azure: ¿qué tipos de discos están disponibles en Azure?"^].
